package com.example.provider.springbootprovider.config;
...
public class KafkaTopicConfig {
    ...
    public NewTopic generateTopic() {
        ...
        configurations.put(TopicConfig.CLEANUP_POLICY_CONFIG, TopicConfig.CLEANUP_POLICY_DELETE); // delete (deletes message) - compact (keeps the most current one)
        ...
        NewTopic newTopic = TopicBuilder.name("ejemplo-topic")
